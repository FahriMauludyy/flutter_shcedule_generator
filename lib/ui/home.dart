...
import 'package:flutter_shcedule_generator/models/task.dart';
import 'package:flutter_shcedule_generator/services/gemini_service.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  // Warna-warna baru
  final Color primaryColor = const Color.fromARGB(255, 225, 137, 255);
  final Color secondaryColor = const Color(0xFF546E7A);
  final Color buttonColor = const Color.fromARGB(255, 189, 104, 183);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 227, 107, 240),
        elevation: 0,
        centerTitle: true,
        actions: [
          IconButton(
